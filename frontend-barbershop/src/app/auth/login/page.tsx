        ...
        <div className="bg-gray-dark/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-light/20 shadow-2xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-dark/80 text-gray-400 font-medium">O continúa con</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-700 py-3.5 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl font-semibold text-base flex items-center justify-center gap-3 border-2 border-gray-200 hover:border-gray-300"
          >
